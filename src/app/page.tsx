    ...
    <Fragment>
      <header className="relative mx-auto max-w-6xl px-4 sm:px-6 md:px-10 lg:px-14 pt-10 sm:pt-12 pb-12 sm:pb-16">
        ...
        >
          ...
          <div className="relative z-10 flex flex-col gap-2.5 sm:gap-3.5 rounded-lg sm:rounded-xl border border-sky-400/20 bg-slate-900/60 p-3.5 sm:p-4 backdrop-blur shadow-[0_0_30px_-10px_rgba(56,189,248,0.2)]">
